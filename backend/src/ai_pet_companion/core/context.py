...
FALLBACK_SOUL = "You are ai_pet_companion, a direct and concise personal AI assistant."
...
async def build_system_prompt(db: aiosqlite.Connection, query: str) -> str:
    ...
    parts.append(
        ...
        " You can act on this machine â€” open links and apps (`open_url`, `open_app`)"
        ...
        ' e.g. [[play_music {"query": "calm down"}]] â€” the app will run it.'
...
def build_user_content(text: str, image_b64: str | None) -> str | list[dict[str, Any]]:
    ...
    straight through â€” never logged, never persisted. A bare base64 string is
