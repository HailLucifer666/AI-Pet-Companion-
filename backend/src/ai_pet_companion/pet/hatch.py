"""Hatch â€” birth the companion: the pet row, a regenerated SOUL.md, and first memories.
...
VOICE_LINES = {
    ...
    "playful": "Playful and light, with real humor â€” never at the cost of clarity.",
...
- When unsure whether an action is wanted, ask â€” one short question.
...
async def hatch(
    ...
    *,
    ...
    # First memories â€” these legitimately form, so they award the pet its first light.
