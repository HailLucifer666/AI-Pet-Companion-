"""Growth ladder — life stages unlock real capability.
...
single config flag (`pet.ignore_ladder`) unlocks everything instantly — charm
...
TOOL_MIN_STAGE: dict[str, int] = {
    ...
    "web_fetch": 2,
    # skill_drafting (reflector) gates at 3, subagents/autonomous_jobs at 4 — wired
...
def locked_message(tool_name: str) -> str:
    ...
    return (
        f"Not grown enough for that yet — the ability to {phrase} unlocks at "
