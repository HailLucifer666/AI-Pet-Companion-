/** cameraFocus â€” a one-shot imperative channel from the "see my pet" button (DOM,
 ...
 *  Kept outside React/zustand â€” like petPos/lure, it's a transient signal, not state.
