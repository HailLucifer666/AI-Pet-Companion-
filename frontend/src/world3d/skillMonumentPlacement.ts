/** skillMonumentPlacement — pure placement for the village's skill monuments.
 *
 ...
 *  imports → unit-testable. Mirrors crystalPlacement's determinism. */
...
/** Deterministic ground spot for a skill monument, ringing the forge at radius 6–8. */
export function skillMonumentPosition(
  ...
  const radius = 6 + r() * 2; // 6–8 units from the forge
